        ...
        <div>
           <div className="relative w-full h-full shadow-2xl" 
            ...
            <div className="flex flex-col md:flex-row justify-between gap-5 md:gap-20 items-center w-4/5 mx-auto py-2 md:py-10">
                <div className="p-5 ">
                    <div>
                        <h1 className="text-lg md:text-6xl font-bold text-orange-400 text-ceter pb-2 md:pb-10">Register Here!</h1>
                        <h1 className="text-lg md:text-2xl font-bold text-orange-400 text-ceter pb-2 md:pb-10">
